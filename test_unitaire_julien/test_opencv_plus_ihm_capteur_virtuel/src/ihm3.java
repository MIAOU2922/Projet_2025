...
public class ihm3 {
    public static void main(String[] args) {
        // Créer le frame
        JFrame frame = new JFrame("IHM Capteur Virtuel 3");
        ...
        initializeTimers(accelXSlider, accelXCheckBox, randomGlobalCheckBox);
        initializeTimers(accelYSlider, accelYCheckBox, randomGlobalCheckBox);
        initializeTimers(accelZSlider, accelZCheckBox, randomGlobalCheckBox);

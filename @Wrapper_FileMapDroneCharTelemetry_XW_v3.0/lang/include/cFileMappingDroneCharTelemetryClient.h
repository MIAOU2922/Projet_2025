...
* @license: BSD License
* @Date : 02/09/2024 modifications : 20/02/2024
...
//------------------------------------------------------------------------------
	...
	//===========================================================================
	/*!
	\file       cFileMappingDroneCharTelemetryClient.h
	...
	*/
	...
	class cFileMappingDroneCharTelemetryClient
	{
		...
		public:
			...
			//! Dectructor of cFileMappingDroneCharTelemetryClient.
...
#endif // !FILEMAPPINGDRONECHARTELEMETRYCLIENT_H
...
//===========================================================================
/*!
Constructor of cFileMappingPictureServeur.
*/
//===========================================================================
cFileMappingPictureServeur::cFileMappingPictureServeur(bool _DebugFlag)
{
	char msg[60];
	this->DebugFlag = _DebugFlag;

#if defined(__WIN32__) || defined(_WIN32) || defined(WIN32) || defined(__WINDOWS__) || defined(__TOS_WIN__) 
	sprintf_s(msg, "<FILEMAPPING PICTURE SERVER v%s>", this->Version.c_str());
#else
	sprintf(msg, "<MAPPING PICTURE SERVER v%s>", this->Version.c_str());
#endif
	std::printf("\n<FILEMAPPING PICTURE SERVER v%s - %s>\n", this->Version.c_str(), this->VersionDate.c_str());
	std::printf("File Map Structure size : %d octets\n", this->FileMapPictureSize);
}

//===========================================================================
/*!
Destructor of cFileMappingPictureServeur.
*/
//===========================================================================
cFileMappingPictureServeur::~cFileMappingPictureServeur()
{
	this->CloseServer();
...
*/
//===========================================================================
bool cFileMappingPictureServeur::OpenServer(char* NameSharedMem)
{
#if defined(__WIN32__) || defined(_WIN32) || defined(WIN32) || defined(__WINDOWS__) || defined(__TOS_WIN__) 
...
*/
//===========================================================================
void cFileMappingPictureServeur::CloseServer()
{
#if defined(__WIN32__) || defined(_WIN32) || defined(WIN32) || defined(__WINDOWS__) || defined(__TOS_WIN__) 																							 
...
\return number of file byte readed or -1 if cannot read file
*/
int cFileMappingPictureServeur::FileToMapFile(char* Name, cVirtualPicture* Data)
{
	int size = -1;
...
*/
int cFileMappingPictureServeur::MapFileToFile(char* Name, cVirtualPicture* Data)
{
	int size = -1;
...
*/
//===========================================================================
int cFileMappingPictureServeur::ReadFileToVirtualPictureStruct(char* Name, cVirtualPicture* Data)
{
	streampos size = -1;
	...
	if (Data != nullptr)
	{
		...
		{
			PrintDebug("ReadFileToMapFile: Ok. Open File <", false);
			...
			FileInput.close();
			PrintDebug("File Readed: the entire file content is in memory ", false);
			PrintDebug(std::to_string((int)size).c_str(), true);
		}
		else
		{
			PrintDebug("ReadFileToMapFile: Error!!! File <", false);
			PrintDebug(Name, false);
			PrintDebug("> not accessible...", true);
			Data->DataPictureSize = -1;
		}
	}
	return Data->DataPictureSize;
}
...
*/
//===========================================================================
cVirtualPicture* cFileMappingPictureServeur::ReadMapFileToVirtualPictureStruct(cVirtualPicture* Data)
{
	if (Data == nullptr)
...
*/
//===========================================================================
int cFileMappingPictureServeur::WriteVirtualPictureStructToFile(char* Name, cVirtualPicture* Data)
{
	int size = -1;
...
*/
//===========================================================================
bool cFileMappingPictureServeur::WriteVirtualPictureStructToMapFile(cVirtualPicture* Data)
{
...
*/
//===========================================================================
void cFileMappingPictureServeur::PrintDebug(const char *msg, bool _Return)
{
	if (this->DebugFlag)
		if (_Return)
...
*/
//===========================================================================
void cFileMappingPictureServeur::PrintStruct(cVirtualPicture* Data)
{
	if (Data != nullptr)
...
*/
//===========================================================================
LPWSTR cFileMappingPictureServeur::ConvCharTabToLPWSTR(const char* msg)
{
...
*/
//===========================================================================
cVirtualPicture* cFileMappingPictureServeur::getVirtualPicturePtr()
{
	if (this->pFileDataStruct != nullptr)
...
*/
//===========================================================================
bool cFileMappingPictureServeur::getDebugMode()
{
...
*/
//===========================================================================
int cFileMappingPictureServeur::getVirtualPictureDataSize()
{
	if (this->pFileDataStruct != nullptr)
...
*/
//===========================================================================
char* cFileMappingPictureServeur::getVirtualPicturePath()
{
...
*/
//===========================================================================
bool cFileMappingPictureServeur::getVirtualPictureMutexBlocAccess()
{
...
*/
//===========================================================================
unsigned char cFileMappingPictureServeur::getMapFileOneByOneUnsignedChar(int pos)
{
	if (this->pFileDataStruct != nullptr)
...
*/
//===========================================================================
unsigned char* cFileMappingPictureServeur::getMapFileBufferData()
{
...
*/
//===========================================================================
int cFileMappingPictureServeur::getFileSize(char* Name)
{
	streampos size;
	ifstream FileInput(Name, ios::in | ios::binary | ios::ate);
...
*/
//===========================================================================
void cFileMappingPictureServeur::setVirtualPicturePtr(cVirtualPicture *VPStruct)
{
...
*/
//===========================================================================
void cFileMappingPictureServeur::setDebugMode(bool _DebugMode)
{
...
*/
//===========================================================================
void cFileMappingPictureServeur::setVirtualPictureDataSize(int size)
{
	if (this->pFileDataStruct != nullptr)
...
*/
//===========================================================================
void cFileMappingPictureServeur::setVirtualPicturePath(char* path)
{
#if defined(__WIN32__) || defined(_WIN32) || defined(WIN32) || defined(__WINDOWS__) || defined(__TOS_WIN__) 																							 
...
*/
//===========================================================================
void  cFileMappingPictureServeur::setVirtualPictureMutexBlocAccess(bool blocaccess)
{
	if (this->pFileDataStruct != nullptr)
...
//===========================================================================
//!
bool cFileMappingPictureServeur::setMapFileOneByOneUnsignedChar(int pos, unsigned char value)
{
	if (this->pFileDataStruct != nullptr)
	{
...
void cFileMappingPictureServeur::setMapFileBufferData(unsigned char* Buf)
{
